...
SAMPLE_NAME="ZHR_Z30_3_ATAC" # e.g. ZHR_1
forward_reads=/scratch/lsa_root/lsa/hertl/1777-HE/TRIMMED_READS/*S371_R1_001_val_1.fq.gz #/path/to/reads
reverse_reads=/scratch/lsa_root/lsa/hertl/1777-HE/TRIMMED_READS/*S371_R2_001_val_2.fq.gz #/path/to/reads
...
# Align reads
bowtie2 --very-sensitive-local -x $indexed_cat_genome \
        -1 $forward_reads \
        -2 $reverse_reads \
...
# Mark duplicates and sort/index
java -jar /nfs/turbo/lsa-wittkopp/Lab/Henry/executables/picard-2.jar MarkDuplicates \
      -I ${SAMPLE_NAME}_${strain1}${strain2}cat.bam \
      -O ${SAMPLE_NAME}_${strain1}${strain2}cat_md.bam \
      -M ${SAMPLE_NAME}_${strain1}${strain2}cat_md_report.txt
samtools sort -O BAM -o ${SAMPLE_NAME}_${strain1}${strain2}cat_md.bam \
        ${SAMPLE_NAME}_${strain1}${strain2}cat_md.bam
samtools index ${SAMPLE_NAME}_${strain1}${strain2}cat_md.bam
