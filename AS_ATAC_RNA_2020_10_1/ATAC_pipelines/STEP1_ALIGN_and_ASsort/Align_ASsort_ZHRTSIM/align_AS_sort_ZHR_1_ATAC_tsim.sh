...
SAMPLE_NAME="ZHR_1_ATAC_tsim" # e.g. ZHR_1
...
cd /nfs/turbo/lsa-wittkopp/Lab/Henry/AS_Integrative_project/ALL_ATAC_ALIGNED/ZHR_1_ATAC #ensure this directory exists
