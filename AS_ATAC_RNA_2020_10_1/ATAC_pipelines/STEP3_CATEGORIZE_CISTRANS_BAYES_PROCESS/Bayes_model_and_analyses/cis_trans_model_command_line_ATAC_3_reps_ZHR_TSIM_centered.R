...
if (Arguments[1] == "Parents") {
  ...
  write.table(Parental_results, file = "./Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq_datafiles/Bayes_test_outputs/Parental_test_output_ZHR_TSIM_ATAC_CPM_macs2_20min_centered1000.txt", row.names = F, quote = F)
  ...
  write.table(Hybrid_results, file = "./Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq_datafiles/Bayes_test_outputs/Hybrid_test_output_ZHR_TSIM_ATAC_CPM_macs2_20min_centered1000.txt", row.names = F, quote = F)
  ...
  write.table(Parental_hybrid_results, file = "./Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq_datafiles/Bayes_test_outputs/Parent_Hybrid_test_output_ZHR_TSIM_ATAC_CPM_macs2_20min_centered1000.txt", row.names = F, quote = F)
