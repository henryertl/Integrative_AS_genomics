...
RNA <- read.delim("./Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/Full_results_output_ZHR_TSIM_RNA_20min.txt", header = T)
RNA$Gene <- gsub("^.{0,6}", "", RNA$Paste_locus)
first_exon_coords <- read.delim("./Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/BED_files_for_analyses/dm6_gene_coords_first_exon.bed", header = F)
...
write.table(RNA_coords, file = "./Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/Full_results_output_ZHR_TSIM_RNA_20min_exon1_coords.txt", row.names = F, quote = F, sep = "\t")

# rearrange RNA_coords in unix to just be coordinates and in BED format for below
awk '{print $46"\t"$47"\t"$48"\t"$45}' \
/Users/henryertl/Documents/Devs/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/Full_results_output_ZHR_TSIM_RNA_20min_exon1_coords.txt > \
/Users/henryertl/Documents/Devs/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/Full_results_output_ZHR_TSIM_RNA_20min_exon1_coords.bed

bedtools sort -i /Users/henryertl/Documents/Devs/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/Full_results_output_ZHR_TSIM_RNA_20min_exon1_coords.bed > \
/Users/henryertl/Documents/Devs/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/Full_results_output_ZHR_TSIM_RNA_20min_exon1_coords_sorted.bed

bedtools closest \
-a /Users/henryertl/Documents/Devs/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq_datafiles/Bayes_test_outputs/Full_results_output_ZHR_TSIM_ATAC_20min1000max_ALL_classes_sorted.bed \
-b /Users/henryertl/Documents/Devs/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/Full_results_output_ZHR_TSIM_RNA_20min_exon1_coords_sorted.bed \
| uniq \
> /Users/henryertl/Documents/Devs/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_RNA_comp/ZHR_TSIM_ATAC_RNA_closest.bed
...
ATAC <- read.delim("./Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq_datafiles/Bayes_test_outputs/Full_results_output_ZHR_TSIM_ATAC_20min1000max_ALL_classes.txt", header = T)
RNA <- read.delim("./Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/Full_results_output_ZHR_TSIM_RNA_20min.txt", header = T)
ATAC_RNA_closest  <- read.delim("./Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_RNA_comp/ZHR_TSIM_ATAC_RNA_closest.bed", header = F, sep = "\t")

## clean up ATAC data - keep relevant columns and separate classes
ATAC_minimal <- ATAC
colnames(ATAC_minimal) <- paste(colnames(ATAC_minimal), "ATAC", sep = "_")
...
colnames(ATAC_minimal_intra_inter)[4] <- "Paste_locus"
colnames(ATAC_minimal_start_end)[4] <- "Paste_locus"
RNA_minimal$Gene <- gsub("^.{0,6}", "", RNA_minimal$Gene)
ATAC_minimal$Direction_ATAC <- NULL
RNA_minimal$Direction_RNA <- NULL
...
colnames(ATAC_minimal_start_end_gene)[35] <- "Name"
colnames(ATAC_minimal_start_end_gene)[36] <- "Gene"
...
write.table(all_classes_integrated, file = "./Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_RNA_comp/ZHR_TSIM_ATAC_RNA_int.txt", quote = F, row.names = F, sep = "\t")
