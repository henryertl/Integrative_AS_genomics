...
SAMPLE_NAME="Z30_5_RNA" # e.g. ZHR_1
forward_reads=/scratch/lsa_root/lsa/hertl/1777-HE/all_raw_reads/*S340_R1_001_val_1.fq.gz #/path/to/reads
reverse_reads=/scratch/lsa_root/lsa/hertl/1777-HE/all_raw_reads/*S340_R1_002_val_2.fq.gz #/path/to/reads
