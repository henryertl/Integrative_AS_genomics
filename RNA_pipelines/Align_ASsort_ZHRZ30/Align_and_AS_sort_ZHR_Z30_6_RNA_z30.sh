...
strain1="ZHR"
strain2="Z30"
strain1_chrom_names="zhr_bow_chrX zhr_bow_chr2L zhr_bow_chr2R zhr_bow_chr3L zhr_bow_chr3R zhr_bow_chr4" # format e.g.: "chrom2L chrom 2R ..." -- ensure matches genome chromosome names
strain2_chrom_names="z30_bow_chrX z30_bow_chr2L z30_bow_chr2R z30_bow_chr3L z30_bow_chr3R z30_bow_chr4"
#####
...
ref_genome1=/nfs/turbo/lsa-wittkopp/Lab/Henry/genome_fasta_and_index/ZHR_genome.fa
ref_genome2=/nfs/turbo/lsa-wittkopp/Lab/Henry/genome_fasta_and_index/Z30_genome.fa
...
refgenome2_fasta=/nfs/turbo/lsa-wittkopp/Lab/Henry/genome_fasta_and_index/dm6.fa
#####
indexed_cat_genome=/nfs/turbo/lsa-wittkopp/Lab/Henry/genome_fasta_and_index/zhr_z30_cat_bowtie_index #path/to/indexed_concatenated_genome
forward_reads=/scratch/lsa_root/lsa/hertl/1777-HE/all_raw_reads/ATAC_raw/1777-HE-1_AGGCAGAA-ATAGAGAG_S362_R1_001_val_1.fq.gz #/path/to/reads
reverse_reads=/scratch/lsa_root/lsa/hertl/1777-HE/all_raw_reads/ATAC_raw/1777-HE-1_AGGCAGAA-ATAGAGAG_S362_R2_001_val_2.fq.gz #/path/to/reads
SAMPLE_NAME="ZHR_Z30_6_RNA" # e.g. ZHR_1
#final_folder_output= # ensure this  directory exists with correct path structure

############## Change directory to sample specific folder #############
cd /nfs/turbo/lsa-wittkopp/Lab/Henry/AS_Integrative_project/ALL_ATAC_ALIGNED/$SAMPLE_NAME #ensure this directory exists
