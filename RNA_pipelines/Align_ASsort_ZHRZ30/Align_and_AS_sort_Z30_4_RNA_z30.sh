...
SAMPLE_NAME="Z30_4_RNA" # e.g. ZHR_1
forward_reads=/scratch/lsa_root/lsa/hertl/1777-HE/all_raw_reads/*S339_R1_001_val_1.fq.gz #/path/to/reads
reverse_reads=/scratch/lsa_root/lsa/hertl/1777-HE/all_raw_reads/*S339_R1_002_val_2.fq.gz #/path/to/reads
