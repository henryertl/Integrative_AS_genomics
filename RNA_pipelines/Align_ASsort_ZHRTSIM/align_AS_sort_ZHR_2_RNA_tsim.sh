...
SAMPLE_NAME="ZHR_2_RNA_tsim" # e.g. ZHR_1
forward_reads=/scratch/lsa_root/lsa/hertl/1777-HE/TRIMMED_READS/*S331_R1_001_val_1.fq.gz #/path/to/reads
reverse_reads=/scratch/lsa_root/lsa/hertl/1777-HE/TRIMMED_READS/*S331_R2_001_val_2.fq.gz #/path/to/reads

#final_folder_output= # ensure this  directory exists with correct path structure

############## Change directory to sample specific folder #############
cd /nfs/turbo/lsa-wittkopp/Lab/Henry/AS_Integrative_project/ALL_RNA_ALIGNED/ZHR_2_RNA #ensure this directory exists
