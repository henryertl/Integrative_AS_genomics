...
write.table(df_RNA_data_genic_counts, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/ZHR_TSIM_genic_counts_final_dm6.txt", row.names = F, quote = F, sep = "\t")
...
full_dataset$HYB_1_P1 >= 20 & full_dataset$HYB_1_P2 >= 20 & full_dataset$HYB_3_P1 >= 20 & full_dataset$HYB_3_P2 >=20 &
...
"HYB_1_P1", "HYB_2_P1", "HYB_3_P1", "HYB_4_P1", "HYB_5_P1", "HYB_6_P1",
"HYB_1_P2", "HYB_2_P2", "HYB_3_P2", "HYB_4_P2", "HYB_5_P2", "HYB_6_P2")
write.table(df_RNA_data_genic_CPM, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/ZHR_TSIM_genic_counts_CPM_final_dm6_20min.txt", row.names = F, quote = F, sep = "\t")
