...
##Read primary data##
#####################
full_dataset <- read.delim("/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/ATAC_seq/Data_tables/ZHR_TSIM_ATAC_txStart500_CPM_final_dm6_20min.txt", header = T)
...
##Combine datasets##
####################
Parental_results <- read.table("/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Parental_test_output_ZHR_TSIM_ATAC_CPM_macs2_20min_txStart.txt", header = T) %>% unique()
Hybrid_results <- read.table("/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Hybrid_test_output_ZHR_TSIM_ATAC_CPM_macs2_20min_txStart.txt", header = T) %>% unique()
Parental_hybrid_results <- read.table("/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Parental_Hybrid_test_output_ZHR_TSIM_ATAC_CPM_macs2_20min_txStart.txt", header = T) %>% unique()
...
ggsave(p_vals, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/ATAC_seq/Figures/p_vals_ZHR_Z30_sub_ATAC_20min_txStart.pdf", width = 15, height = 15)
...
write.table(Full_results_output, file = "~/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Full_results_output_ZHR_Z30_ATAC_20min_txStart.txt", sep = "\t", row.names = F, quote = F)
...
ggsave(perc_cis, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/ATAC_seq/Figures/perc_cis_ZHR_Z30_sub_ATAC_CPM_20min_txStart.pdf", width = 15, height = 15)
...
ggsave(cis_trans_ATAC_CPM, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/ATAC_seq/Figures/cis_trans_ZHR_Z30_ATAC_sub_CPM_20min_ALL_txStart.pdf", width = 15, height = 15)
...
ggsave(facet_all, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/ATAC_seq/Figures/cis_trans_ZHR_Z30_ATAC_CPM_20min_ALL_reg_classes_facet_txStart.pdf", width = 15, height = 15)

facet_cis_trans <- plot_grid(C, D, E, G)

ggsave(facet_cis_trans, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/ATAC_seq/Figures/cis_trans_ZHR_Z30_ATAC_CPM_20min_cis_trans_reg_classes_facet_txStart.pdf", width = 15, height = 15)
