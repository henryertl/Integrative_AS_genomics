...
##Read primary data##
#####################
full_dataset <- read.delim("/Users/wittkopp_member/Code/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq/Data_tables/ZHR_TSIM_ATAC_txEnd500_CPM_final_dm6_20min.txt", header = T)
...
##Combine datasets##
####################
Parental_results <- read.table("/Users/wittkopp_member/Code/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Parental_test_output_ZHR_TSIM_ATAC_CPM_macs2_20min_txEnd.txt", header = T) %>% unique()
Hybrid_results <- read.table("/Users/wittkopp_member/Code/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Hybrid_test_output_ZHR_TSIM_ATAC_CPM_macs2_20min_txEnd.txt", header = T) %>% unique()
Parental_hybrid_results <- read.table("/Users/wittkopp_member/Code/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Parental_hybrid_test_output_ZHR_TSIM_ATAC_CPM_macs2_20min_txEnd.txt", header = T) %>% unique()
...
write.table(Full_results_output, file = "/Users/wittkopp_member/Code/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Full_results_output_ZHR_TSIM_ATAC_20min_txEnd.txt", sep = "\t", row.names = F, quote = F)
