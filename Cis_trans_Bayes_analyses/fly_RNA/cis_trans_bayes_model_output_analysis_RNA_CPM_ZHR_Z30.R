...
##Combine datasets##
####################
full_dataset <- read.delim("Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/ZHR_Z30_genic_counts_CPM_final_dm6_20min_1000max.txt", header = T)
...
Parental_data <- full_dataset[, c("Paste_locus", "P1_1", "P1_2", "P1_3", "P1_4", "P1_5", "P1_6", "P2_1", "P2_2", "P2_3", "P2_4", "P2_5", "P2_6")]

Hybrid_data <- full_dataset[, c("Paste_locus", "HYB_1_P1", "HYB_2_P1", "HYB_3_P1", "HYB_4_P1", "HYB_5_P1", "HYB_6_P1", "HYB_1_P2", "HYB_2_P2", "HYB_3_P2", "HYB_4_P2", "HYB_5_P2", "HYB_6_P2")]


####################
##Combine datasets##
####################
Parental_results <- read.table("Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Bayes_outputs/Parental_test_output_ZHR_Z30_RNA_full_CPM_20_1000.txt", header = T)
Hybrid_results <- read.table("Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Bayes_outputs/Hybrid_test_output_ZHR_Z30_RNA_full_CPM_20_1000.txt", header = T)
Parental_hybrid_results <- read.table("Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Bayes_outputs/Parental_Hybrid_test_output_ZHR_Z30_RNA_full_CPM_20_1000.txt", header = T)
...
write.table(Full_results_output, file = "Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/RNA_seq/Data_tables/Full_results_output_ZHR_Z30_RNA_20min_100max.txt", sep = "\t", row.names = F, quote = F)
