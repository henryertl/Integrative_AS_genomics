...
##Combine datasets##
####################
full_dataset <- read.delim("/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/four_yeast_AS_RNA_CPM_C_M.txt", header = T)
...
Parental_data <- full_dataset[, c("Paste_locus", "P1_1", "P1_2", "P2_1", "P2_2")]

Hybrid_data <- full_dataset[, c("Paste_locus", "HYB_1_P1", "HYB_2_P1", "HYB_1_P2", "HYB_2_P2")]


####################
##Combine datasets##
####################
Parental_results <- read.table("/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Parental_test_output_C_M_RNA_full_CPM.txt", header = T)
Hybrid_results <- read.table("/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Hybrid_test_output_C_M_RNA_full_CPM.txt", header = T)
Parental_hybrid_results <- read.table("/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Parental_hybrid_test_output_C_M_RNA_full_CPM.txt", header = T)
...
#ggsave(p_vals, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/RNA_seq/Figures/p_vals_ZHR_Z30_RNA_20min_100max.pdf", width = 15, height = 15)
...
if (Full_results_output$P1_1[i] > Full_results_output$P2_1[i] & Full_results_output$P1_2[i] > Full_results_output$P2_2[i]){

	Full_results_output$Direction_parent[i] <- "P1"

} else if (Full_results_output$P1_1[i] < Full_results_output$P2_1[i] & Full_results_output$P1_2[i] < Full_results_output$P2_2[i]){
...
if (Full_results_output$HYB_1_P1[i] > Full_results_output$HYB_1_P2[i] & Full_results_output$HYB_2_P1[i] > Full_results_output$HYB_2_P2[i]){

	Full_results_output$Direction_hybrid[i] <- "P1"

} else if (Full_results_output$HYB_1_P1[i] < Full_results_output$HYB_1_P2[i] & Full_results_output$HYB_2_P1[i] < Full_results_output$HYB_2_P2[i]){
...
# edit out paste locus for gene name
Full_results_output <- Full_results_output %>%
  mutate(Gene = str_sub(Paste_locus, 7, -1))

  Full_results_output$Paste_locus <- NULL
  Full_results_output$chrom <- NULL
  Full_results_output$pos_start <- NULL
  Full_results_output$pos_end <- NULL

write.table(Full_results_output, file = "/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Cis_trans_bayes_output_C_M_RNA_CPM.txt", sep = "\t", row.names = F, quote = F)
...
theme_main() +
xlab("Percent Cis") +
ggtitle("D.mel,ZHR - D.mel,Z30 Gene Expression divergence")
ggsave(perc_cis, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/RNA_seq/Figures/perc_cis_ZHR_Z30_RNA_CPM_20min_1000max.pdf", width = 15, height = 15)


cis_trans_RNA_CPM <- Full_results_output %>%
...
ggsave(cis_trans_RNA_CPM, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/RNA_seq/Figures/cis_trans_ZHR_Z30_RNA_CPM_20min_1000max_ALL.pdf", width = 15, height = 15)
...
ggsave(facet_all, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/RNA_seq/Figures/cis_trans_ZHR_Z30_RNA_CPM_20min_ALL_reg_classes_facet.pdf", width = 15, height = 15)

facet_cis_trans <- plot_grid(C, D, E, G)

ggsave(facet_cis_trans, file = "/Users/henryertl/Documents/Wittkopp_lab/AS_ATAC_RNA_2020_10_1/RNA_seq/Figures/cis_trans_ZHR_Z30_RNA_CPM_20min_cis_trans_reg_classes_facet.pdf", width = 15, height = 15)
