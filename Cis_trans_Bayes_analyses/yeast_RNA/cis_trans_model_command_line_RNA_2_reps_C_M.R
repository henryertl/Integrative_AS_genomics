...
if (Arguments[1] == "Parents") {
  ...
  write.table(Parental_results, file = "/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Parental_test_output_C_M_RNA_full_CPM.txt", row.names = F, quote = F)
  ...
  write.table(Hybrid_results, file = "/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Hybrid_test_output_C_M_RNA_full_CPM.txt", row.names = F, quote = F)
  ...
  write.table(Parental_hybrid_results, file = "/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Parental_Hybrid_test_output_C_M_RNA_full_CPM.txt", row.names = F, quote = F)
