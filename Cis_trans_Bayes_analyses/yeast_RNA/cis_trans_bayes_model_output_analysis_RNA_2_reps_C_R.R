...
##Combine datasets##
####################
full_dataset <- read.delim("/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/four_yeast_AS_RNA_CPM_C_R.txt", header = T)
...
##Combine datasets##
####################
Parental_results <- read.table("/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Parental_test_output_C_R_RNA_full_CPM.txt", header = T)
Hybrid_results <- read.table("/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Hybrid_test_output_C_R_RNA_full_CPM.txt", header = T)
Parental_hybrid_results <- read.table("/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Parental_hybrid_test_output_C_R_RNA_full_CPM.txt", header = T)
...
write.table(Full_results_output, file = "/Users/henryertl/Documents/Wittkopp_lab/Four_spp_yeast/Cis_trans_bayes_output_C_R_RNA_CPM.txt", sep = "\t", row.names = F, quote = F)
