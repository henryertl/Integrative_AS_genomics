...
inter <- read.delim("/Users/wittkopp_member/Code/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Full_results_output_ZHR_TSIM_ATAC_20min_intergenic.txt", header = T)
inter$class <- "inter"

intra <- read.delim("/Users/wittkopp_member/Code/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Full_results_output_ZHR_TSIM_ATAC_20min_intragenic.txt", header = T)
intra$class <- "intra"
...
end <- read.delim("/Users/wittkopp_member/Code/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq/Bayes_test_outputs/Full_results_output_ZHR_TSIM_ATAC_20min_txEnd.txt", header = T)
end$class <- "end"

# concatenate
ALL <- bind_rows(inter, intra, start, end)
ALL_shortened <- ALL[,1:4]
write.table(ALL, file="/Users/wittkopp_member/Code/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq/ZHR_TSIM_Full_results_output_ALL_classes.txt", sep = "\t", row.names = F, quote = F)
write.table(ALL_shortened, file="/Users/wittkopp_member/Code/Integrative_AS_genomics/AS_ATAC_RNA_2020_10_1/ATAC_seq/ZHR_TSIM_Full_results_output_ALL_classes_shortened.bed", sep = "\t", row.names = F, quote = F)
