...
# read in datasets
ZHR_Z30_all <- read.delim("/nfs/turbo/lsa-wittkopp/Lab/Henry/AS_Integrative_project/MERGED_AND_FINAL_FILES/ATAC/ZHR_Z30_ATAC_merged_counts_final_peakset.bed", header = F)
ZHR_TSIM_all <- read.delim("/nfs/turbo/lsa-wittkopp/Lab/Henry/AS_Integrative_project/MERGED_AND_FINAL_FILES/ATAC/ZHR_TSIM_ATAC_merged_counts_final_peakset.bed", header = F)
...
down_samp_final <- d_merge24[rev(4:28)]
colnames(down_samp_final) <- c(c("chrom", "start", "end", "ZHR_1", "ZHR_2", "ZHR_3", "Z30_1", "Z30_2", "Z30_3", "HYB_1_ZHR", "HYB_2_ZHR", "HYB_3_ZHR", "HYB_1_Z30", "HYB_2_Z30", "HYB_3_Z30", "ZHR_1_tsim", "ZHR_2_tsim", "ZHR_3_tsim", "TSIM_1", "TSIM_2", "TSIM_3", "HYB_1_ZHR_tsim", "HYB_2_ZHR_tsim", "HYB_3_ZHR_tsim", "HYB_1_TSIM", "HYB_2_TSIM", "HYB_3_TSIM")
write.table(down_samp_final, file = "/nfs/turbo/lsa-wittkopp/Lab/Henry/ZHR_Z30_TSIM_combined_final_ATAC_downsampled.txt", sep = "\t", row.names = F, quote = F)
