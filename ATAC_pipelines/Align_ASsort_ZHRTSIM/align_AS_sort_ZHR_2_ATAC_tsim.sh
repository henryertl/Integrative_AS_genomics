...
SAMPLE_NAME="ZHR_2_ATAC_tsim" # e.g. ZHR_1
...
cd /nfs/turbo/lsa-wittkopp/Lab/Henry/AS_Integrative_project/ALL_ATAC_ALIGNED/ZHR_2_ATAC #ensure this directory exists
