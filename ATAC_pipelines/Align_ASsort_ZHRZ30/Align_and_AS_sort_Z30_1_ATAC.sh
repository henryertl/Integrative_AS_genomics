...
SAMPLE_NAME="Z30_1_ATAC" # e.g. ZHR_1
forward_reads=/scratch/lsa_root/lsa/hertl/1777-HE/TRIMMED_READS/*S363_R1_001_val_1.fq.gz #/path/to/reads
reverse_reads=/scratch/lsa_root/lsa/hertl/1777-HE/TRIMMED_READS/*S363_R2_001_val_2.fq.gz #/path/to/reads
